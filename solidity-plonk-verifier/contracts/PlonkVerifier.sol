...
contract PlonkVerifier {
  ...
  // ----------------------- vk ---------------------
  uint256 private constant VK_NB_PUBLIC_INPUTS = 64;
  ...
  uint256 private constant VK_QL_COM_X = 14476943698878436343821276630966918415674107021746205108680755576980582451131;
  uint256 private constant VK_QL_COM_Y = 5394016988936454062578820333707454971484019973364125656231519651134666769412;
  uint256 private constant VK_QR_COM_X = 17259037924242697526628504124097653849625792957824017881748527911614485589374;
  uint256 private constant VK_QR_COM_Y = 19107545057239707609306350668131531687090882195988949158481440440255059418304;
  uint256 private constant VK_QM_COM_X = 7528993557140335705709536591201767508058811930702810188717262941662464933299;
  uint256 private constant VK_QM_COM_Y = 4411451787028426627821495143493042595638672111782634664116928529750276755991;
  uint256 private constant VK_QO_COM_X = 16725263059191169116724668662008532105985133829729674520455956341796892131050;
  uint256 private constant VK_QO_COM_Y = 9131592786364031264731348644183867865589674315418061804792628825720863309197;
  uint256 private constant VK_QK_COM_X = 977489248703087214923254415591408191529840617187656900943602613403848340353;
  uint256 private constant VK_QK_COM_Y = 21814205223361062179469872443937069983890421803960629188603660260477245855814;
  
  uint256 private constant VK_S1_COM_X = 8635395089698221579303225525504117107502104494722337992539473286505194839058;
  uint256 private constant VK_S1_COM_Y = 8326316549540571556300442063803678447323445612332252612734231062986941220833;
  
  uint256 private constant VK_S2_COM_X = 3966779639817683018600677580249672739116955459694048530600422761057047200456;
  uint256 private constant VK_S2_COM_Y = 17291481853478162564573159408807614781158831105848219758467516631580779801753;
  
  uint256 private constant VK_S3_COM_X = 17076137738457439604751323320801601914647306130949913086371075443037248017224;
  uint256 private constant VK_S3_COM_Y = 12457651729055293668118075446198856872777505946652972534545518332940628638557;
  
  uint256 private constant VK_COSET_SHIFT = 5;
  
  
  uint256 private constant VK_QCP_0_X = 17898183934963212155293442586844738793852437708067711524165576440893097724043;
  uint256 private constant VK_QCP_0_Y = 12560898312486936655801255053660352089034911901709578755913472606499216379032;
  
  
  uint256 private constant VK_INDEX_COMMIT_API0 = 8849192;
